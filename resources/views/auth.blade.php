    ...
    <section class="dashboard_part bg-white">
        <div class="d-flex align-items-center position-relative min-vh-100">
                ...
                <div class="w-100 padding-50px-all sm-padding-30px-all xs-padding-20px-all">
                    <div class=" cs_modal">
                        <div class="modal-header bg-white">
                            <h5 class="modal-title" id="title-login">Log in Institusi</h5>
                            <button class="btn btn-primary" id="switch-login" data-type="institusi">Login
                                Personal</button>
                        </div>
                        <div class="modal-body">
                            <form autocomplete="off" action="{{ route('login') }}" method="POST">
                                ...
                                <button type="submit" class="btn_1 full_width text-center">Log
                                    in</button>
                                <p>Belum terdaftar di sistem? <a data-bs-toggle="modal" data-bs-target="#sing_up"
            ...
            <div class="container-fluid bg-img height-100vh d-none d-lg-flex justify-content-center align-items-center">
                ...
                <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_mjlh3hcy.json"
    ...
    <script>
        $(document).ready(function() {
            $('#switch-login').click(function() {
                ...
                if (dataType == 'institusi') {
                    $('#title-login').html('Log in Personal');
                    $(this).html('Login Institusi');
                    $(this).data('type', 'personal');
                    $('input[name="type"]').val(2);
                } else {
                    $('#title-login').html('Log in Institusi');
                    $(this).html('Login Personal');
                    $(this).data('type', 'institusi');

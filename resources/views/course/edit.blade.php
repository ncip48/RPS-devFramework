            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="QA_section">
                        ...
                        <div class="QA_table ">
                            <form action="{{ route('materi.update', $course) }}" method="POST" autocomplete="off">
                                @csrf
                                @method('PUT')
                                        ...
                                        <select name="id_institute" id="id_institute" class="form-control">
                                            @foreach ($institutes as $institute)
                                                <option value="{{ $institute->id }}"
                                                    {{ $institute->id == $course->id_institute ? 'selected' : '' }}>
                                    ...
                                    <select name="id_department" id="id_department" class="form-control">
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}"
                                                {{ $department->id == $course->id_department ? 'selected' : '' }}>
                                                {{ $department->code }} -
                                    ...
                                    <select name="id_teacher" id="id_teacher" class="form-control">
                                        @foreach ($teachers as $teacher)
                                            <option value="{{ $teacher->id }}"
                                                {{ $teacher->id == $course->id_teacher ? 'selected' : '' }}>
                                                {{ $teacher->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_teacher')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control"
                                        placeholder="Code" value="{{ old('code', $course->code) }}">
                                    @error('code')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="Name" value="{{ old('name', $course->name) }}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="credit" id="credit" class="form-control"
                                        placeholder="Credit" value="{{ old('credit', $course->credit) }}">
                                    @error('credit')
